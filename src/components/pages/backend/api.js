...
export const getYieldListFromServer = () => {
  // return yieldList
  return fetch(
    "https://atc-bl.nadzor.online/bl198765/admin/other/platformProfit",
    {
      headers: {
        Authorization: `Bearer ${localStorage.getItem("token")}`
      }
...
export const getArticlesFromServer = () => {
  // return articleList
  return fetch(
    "https://atc-bl.nadzor.online/bl198765/platform/news?offset=0&limit=10",
    {
      headers: {
        Authorization: `Bearer ${localStorage.getItem("token")}`
      }
...
export const investmentsReportFromServer = () => {
  return fetch(
